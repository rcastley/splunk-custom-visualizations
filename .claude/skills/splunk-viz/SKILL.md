...
For the harness, see the [Studio Extension Harness](references/dse-framework.md#testing) section of the reference doc — the legacy Step 5 harness pattern below does not apply to Track B vizs.
